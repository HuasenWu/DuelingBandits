...
//
// CAlg_DTS2.h : our Double Thompson Sampling algorithm 
// Reference:   Huasen Wu, et al., "Double Thompson Sampling for Dueling Bandits"
//
// Note: in our paper, it is the simplified version of D-TS
//       This class is defined indepedently (instead of adjust it from the "CAlg_DTS" class, so that it is easier to try different methods
//
...
private:
	...
	int selectFirstCandidate(vector<int> cpldScores, vector<int> candidates);
