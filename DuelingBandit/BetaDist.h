//
// BetaDist.h: General Beta distributed random variable by using the Gamma distributed r.v. 
// 
// Author: Joseph Mansfield
// From:   http://stackoverflow.com/questions/15165202/random-number-generator-with-beta-distribution
//
